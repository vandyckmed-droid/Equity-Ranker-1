...
def get_rankings(
    ...
    for _, row in df.iterrows():
        ...
        stocks.append({
            ...
            "zM1":       safe(row.get("zM1")),
            "zLowVol":   safe(row.get("zLowVol")),
            "zOPA":      safe(row.get("zOPA")),
            "zRam6":     safe(row.get("zRam6")),
            "zRam12":    safe(row.get("zRam12")),
            "zRam1":     safe(row.get("zRam1")),
            "res6":      safe(row.get("res6")),
            "res12":     safe(row.get("res12")),
            "M6blend":   safe(row.get("M6_blend")),
            "M12blend":  safe(row.get("M12_blend")),
